	...
	return (
	  <div className="body_wrapper">
		...
		<section className="content">
		  ...
		  <iframe width={560} height={315} src="https://www.youtube.com/embed/51nfpGY_AJk" frameBorder={0} allowFullScreen />
		  <hr />
		  ...
		  <fieldset>
			...
			<form>
			  ...
			  <p><label htmlFor="text_field_disabled">Disabled Text Field:</label><br />
				<input type="text" id="text_field_disabled" disabled defaultValue="I'm disabled" />
			  </p>
			  <p><label htmlFor="text_field_readonly">Readonly Text Field:</label><br />
				<input type="text" id="text_field_readonly" readOnly defaultValue="I'm readonly" />
			  </p>
			  <p><label htmlFor="text_area">Text Area:</label><br />
				<textarea id="text_area" defaultValue={""} />
			  </p>
			  <p><label htmlFor="text_area_disabled">Disabled Text Area:</label><br />
				<textarea id="text_area_disabled" disabled defaultValue={"I'm disabled"} />
			  </p>
			  <p><label htmlFor="text_area">Readonly Text Area:</label><br />
				<textarea id="text_area" readOnly defaultValue={"I'm readonly"} />
			  </p>
			  ...
			  <p><label htmlFor="select_element_disabled">Disabled Select Element:</label><br />
			  ...
			  <p>Radio Buttons:<br />
				<label><input type="radio" className="radio" name="radio_button" defaultValue="radio_1" /> Radio 1</label><br />
				<label><input type="radio" className="radio" name="radio_button" defaultValue="radio_2" /> Radio 2</label><br />
				<label><input type="radio" className="radio" name="radio_button" defaultValue="radio_3" /> Radio 3</label><br />
				<label><input type="radio" className="radio" name="radio_button" defaultValue="radio_4" disabled /> Radio Disabled</label><br />
			  </p>
			  <p>Checkboxes:<br />
				<label><input type="checkbox" className="checkbox" name="checkboxes" defaultValue="check_1" /> Checkbox 1</label><br />
				<label><input type="checkbox" className="checkbox" name="checkboxes" defaultValue="check_2" /> Checkbox 2</label><br />
				<label><input type="checkbox" className="checkbox" name="checkboxes" defaultValue="check_3" /> Checkbox 3</label><br />
				<label><input type="checkbox" className="checkbox" name="checkboxes" defaultValue="check_4" disabled /> Checkbox Disabled</label><br />
			  </p>
			  ...
			  <p><label htmlFor="tel">Telephone:</label><br />
				<input type="tel" id="tel" />
			  </p>
			  <p><label htmlFor="number">Number:</label><br />
			  ...
			  <p><label htmlFor="time">Time:</label><br />
				<input type="time" id="time" />
			  </p>
			  <p><label htmlFor="color">Color:</label><br />
				<input type="color" id="color" />
			  </p>
			  <p><label htmlFor="datalist">Datalist:</label><br />
			  ...
			  <p><label htmlFor="range">Range:</label><br />
				<input type="range" id="range" name="points" min={1} max={10} />
			  </p>
			  <p><label htmlFor="output">Output:</label><br />
				<output name="result" id="output">42</output>
			  </p>
			  <p><label htmlFor="progress">Progress:</label><br />
				<progress id="progress" value={65} max={100} />
			  </p>
			  <p><label htmlFor="meter">Meter:</label><br />
				<meter id="meter" min={200} max={500} value={350}>350 degrees</meter>
			  </p>
			  <p>
				<button className="button">Button Element</button>
				<input className="button" type="reset" defaultValue="Clear" />
				<input className="button" type="submit" defaultValue="Submit" />
				<input className="button prm-but" type="submit" defaultValue="Primary" />
				<input className="button sec-but" type="submit" defaultValue="Secondary" />
				<input className="button ter-but" type="submit" defaultValue="Tertiary" />
			  </p>
			</form>
		  </fieldset>
		</section>
